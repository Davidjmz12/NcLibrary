...
Finally, we have to set the *R* environment. As the execution of Python code is essential, the R library *reticulate* is employed. An independent *conda* environment with all the libraries needed will be created using the following function. Please note that if this configuration has been completed previously, it may be skipped.
